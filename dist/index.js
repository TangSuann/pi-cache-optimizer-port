...
export default definePluginEntry({
    ...
    description: "Phase one: persists normalized per-provider/model prompt-cache statistics " +
    ...
    register(api) {
        ...
        api.registerCommand({
            ...
            description: "Show persisted per-model prompt-cache statistics (hit requests, cached/total input tokens).",
            acceptsArgs: false,
            requireAuth: true,
            handler: () => {
